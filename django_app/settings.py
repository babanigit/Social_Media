...
print("the base url is:- ", BASE_DIR)
# BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
STATIC_URL = "/static/"
STATICFILES_DIRS = [
    # this should match the folder you output into:
    os.path.join(BASE_DIR, "django_app", "static", "angular", "browser"),
]
...
SECRET_KEY = "django-insecure-!@iz$6o=sufd+-t4z+c#)ghjblnown@=kvj_lqw2p5gngi))a7"
